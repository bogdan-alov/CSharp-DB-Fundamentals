namespace BookShopSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopSystem.Data.BookShopContext>
    {
        ...
        {
            int booksCount = context.Books.ToList().Count;

            string[] categories = File.ReadAllLines(@"c:\users\bogdan alov\documents\visual studio 2015\Projects\BookShopSystem\BookShopSystem\Import\categories.csv");
